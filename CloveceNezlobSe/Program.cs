...
turnaj.PridejStrategii(new("Smurf", hra => new HerniStrategieMartinFTurboSmurf(new HerniStrategieMartinFVahyTurboSmurf() { VahaVyhozeniProtivnika = 3.69919747431525, VahaJduDoDomecku = 4.531963965779127, VahaRizikoVyhozeni = 0.2764019305968857, VahaPreferujiVzdalenost = 3.955984914490582, VahaJeZamnouProtihrac = 0.9618506213237696, VahaJduNaNaraznik = 0.3449522701085842, ThresholdPodKteryNehraju = 0.30207347672459955 })));
turnaj.PridejStrategii(new("MartinT", hra => new HerniStrategieMartinT(hra)));
