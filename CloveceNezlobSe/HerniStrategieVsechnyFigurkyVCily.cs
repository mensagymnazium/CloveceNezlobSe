...
{
    internal class HerniStrategieVsechnyFigurkyVCily : HerniStrategieTahniPrvniMoznouFigurkou
	{
		public HerniStrategieVsechnyFigurkyVCily(Hra hra) : base(hra)
		{
		}
		...
		public override Figurka? DejFigurkuKterouHrat(Hrac hrac, int hod)
		{
			...
			{
				figurka.Policko.JeDomecek.Equals(true);
